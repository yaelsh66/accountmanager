...
from .views import ExcelUploadView, ExpensesListView, CategoryListCreateView, ExpensesDetailView, ExpensesSummaryView
...
urlpatterns = [
    ...
    path('api/summary/', ExpensesSummaryView.as_view(), name='expenses-summary'),
]
